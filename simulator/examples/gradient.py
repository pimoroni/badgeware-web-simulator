# brush.gradient paints a smooth colour ramp. A LINEAR gradient fills the rounded
# rectangle (its axis rotating over time) and a RADIAL one lights the circle.
# Stops are (position 0..1, color); a mat3 maps them onto each shape.
