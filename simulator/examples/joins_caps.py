# How strokes handle corners and ends. Top row: the line joins (JOIN_MITER /
# JOIN_ROUND / JOIN_BEVEL) on a sharp chevron. Bottom row: the line caps
# (CAP_BUTT / CAP_ROUND / CAP_SQUARE) on an open segment.
