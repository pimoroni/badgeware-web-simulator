# algorithm.clip_line(p1, p2, rect) trims a line segment to a rectangle, moving
# p1/p2 to the clipped endpoints and returning False for lines fully outside it
