# .stroke(thickness, flags) turns a shape into its outline. The alignment flag
# (ALIGN_INNER / ALIGN_CENTER / ALIGN_OUTER) sets which side of the path the
# thickness grows on; PATH_OPEN leaves a polyline unclosed.
